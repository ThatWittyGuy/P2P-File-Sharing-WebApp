...
export const SP = ({ children }: { children: React.ReactNode }) => {
  ...
  // *** THIS IS THE FIX ***
  // We memoize the provider's value object.
  // This ensures that the `socket` and `userId` references
  // do not change when `peerState` or `SocketId` are updated.
  const providerValue = useMemo(
    ...
    [socket, userId, SocketId, peerState] // setSocketId/setpeerState are stable
  );
